---
layout: default
title: Tiation Ai Code Assistant - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Ai Code Assistant</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-ai-code-assistant" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t tiation-ai-code-assistant .

# Run container
docker run -p 8080:8080 tiation-ai-code-assistant
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-ai-code-assistant)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-ai-code-assistant/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-ai-code-assistant/discussions)
